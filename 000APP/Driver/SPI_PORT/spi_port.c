...
//    gpio_mode_set(GPIOA, GPIO_MODE_OUT_PULLUP, GPIO_OSPEED_50MHZ, GPIO_PIN_4);

//    rcu_periph_clock_enable(RCU_SPI0);
//    gpio_mode_set(GPIOA, GPIO_MODE_AF_PP, GPIO_OSPEED_50MHZ, GPIO_PIN_5|GPIO_PIN_6|GPIO_PIN_7);
