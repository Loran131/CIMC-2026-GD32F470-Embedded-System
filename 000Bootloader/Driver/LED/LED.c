...
void LED_Init(void)
{
	...
	//初始化LED1端口
	gpio_mode_set(GPIOA, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO_PIN_8);   			// GPIO模式设置为输出
    gpio_output_options_set(GPIOA, GPIO_OTYPE_PP, GPIO_OSPEED_50MHZ, GPIO_PIN_8);   // 输出参数设置
	gpio_bit_reset(GPIOA, GPIO_PIN_8);  											// 引脚初始电平为低电平
